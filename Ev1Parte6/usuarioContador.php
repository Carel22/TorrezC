...
<head>
    ...
    <title>Página de cuentas bancarias-Contador</title>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="usuarioContadortransacciones.php" target="_blank">Transacciones</a>
                </li>
          </ul>
...
<form action="adicionaCuentaCA.php" method="POST">
...
echo "$saldo_actual";
            ...
            <td><a href="cambiarCuentaCA.php?id=<?= $row['id_Cuenta'] ?>" class="users-table--edit">Cambiar</a></td> 
        </tr>
    <?php endwhile; ?>
</tbody>
