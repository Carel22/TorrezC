...
if ($query) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        <head>
            ...
            <title>Cajero - Editar Transaccion </title>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item d-flex align-items-center">
              <a class="btn btn-redondo  btn-sm" href="index.php">Inicio de Sesión</a>
                ...
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="usuarioContador.php" target="_blank">Cuentas</a>
                </li>
                <li class="nav-item">
    ...
    <h2>EDITA DATOS </h2>
        ...
        <form action="editTransaccionCA.php" method="POST">
