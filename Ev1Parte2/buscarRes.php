...
<nav class="navbar navbar-expand-lg bg-warning">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item d-flex align-items-center">
            ...
            <div class="input-group">
                <input class="form-control me-2" name="id_Persona" type="text" placeholder="Introduce id_Persona" aria-label="Introduce id_Persona">
        ...
        <input class="form-control me-2" type="buscar" placeholder="Introduce id_Persona" aria-label="Introduce id_Persona">
        <button class="btn btn-outline-success" type="submit">Buscar</button>-->
      </form>
        </div>
      </div>
