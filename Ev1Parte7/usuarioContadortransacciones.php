...
<form action="adicionarTransaccionCA.php" method="POST">
...
<th><a href="cambiarTransaccionCA.php?id=<?= $row['id_Transaccion'] ?>" class="users-table--edit">Actualizar</a></th>
<th><a href="borrarTransaccionCA.php?id=<?= $row['id_Transaccion'] ?>" class="users-table--delete" >Eliminar</a></th>   
</tr>
