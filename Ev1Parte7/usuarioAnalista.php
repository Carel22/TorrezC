...
<head>
    ...
    <title>Página del usuario Analista</title>
...
<th><a href="indexAgregarUA.php?id=<?= $row['id_Persona'] ?>" class="users-table--edit">Editar</a></th>
<th><a href="indexDeleteUA.php?id=<?= $row['id_Persona'] ?>" class="users-table--delete" >Borrar</a></th>   
</tr>
<?php endwhile; ?>
            </tbody>
        </table>
